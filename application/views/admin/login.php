<?php include(FCPATH.'application\views\header.php') ?>
    ...
    <section class="login-clean">
        <form method="post" action="<?= site_url('admin/LoginAdminController/login')?>">
            <div class="illustration">
                <h1 style="color: var(--dark);font-size: 35px;">Login Admin</h1>
            </div>
            <div class="form-group">
                <p>Email</p><input name="contact" type="email" value="admin@gmail.com">
            </div>
            <div class="form-group">
                <p>Mot de passe</p><input type="password" name="mdp" value="admin">
            </div>
            <div class="form-group">
